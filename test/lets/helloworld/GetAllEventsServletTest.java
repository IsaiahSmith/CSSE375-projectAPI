 ...
 * @author duffytj
 */
public class GetAllEventsServletTest {
    
    URL url;
    URLConnection connection;
    String title;
    
    public GetAllEventsServletTest() {
        try {
    ...
    /**
     * Test of processRequest method, of class GetAllEventsServlet.
     */
    @Test
    public void testProcessRequest() throws Exception {
        ...
        if (actual.equals(this.title)) {
            System.out.println("Event Insert & Get Success!");
        }
    }
